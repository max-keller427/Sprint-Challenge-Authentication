...
To persist authentication data, preventing the user from having to authenticate every time the page reloads.

1. What does bcrypt do to help us store passwords in a secure manner.

Bcrypt hashes the data, meaning it uses an algorithm to translate the data into an indecipherable string

1. What does bcrypt do to slow down attackers?

One of the parameters the hashSync function takes is the amount of times the password will be hashed. So hasing hashes.
